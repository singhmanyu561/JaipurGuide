...
const useStyles = makeStyles((theme) => ({
    ...
    profile: {
        ...
        color: 'white',
        fontSize: 70,
        '&:hover': { fontSize: 80, cursor: 'pointer', color: '#ba0cf4' }
    },
        ...
        <div className={classes.root}>
            ...
            <AppBar position="static" style={{ backgroundImage: `url('https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse1.mm.bing.net%2Fth%3Fid%3DOIP.Huw0oRVfEdcFwvZUu5DBeAHaDH%26pid%3DApi&f=1')`, backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundAttachment: 'fixed', opacity: 1, height: 110 }}>
                <Toolbar >
                    ...
                    <AccountCircleIcon className={classes.profile} onClick={toggleDrawer('right', true)} style={{}} />

                    
                    {/* <Button className={classes.button} onClick={logout} style={{ backgroundColor: 'green', position: 'absolute', right: 120}} >Logout</Button> */}
            ...
            <div>
                ...
                >
                    ...
                    <DialogActions style={{ background: '#f7925b' }}>
                        ...
                        {/* <Button onClick={() => { setOpenBooking(false) }} color="primary">
                            Agree
                        </Button> */}
                    </DialogActions>
                </Dialog>
